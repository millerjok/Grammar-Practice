      ...
      <div className="print-only">
        <div className="mb-8">
          <div className="flex justify-between items-end border-b-2 border-black pb-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">Generated by AI Practice Dojo</p>
            </div>
          ...
          <div className="mb-8 bg-gray-50 p-6 rounded-xl border border-gray-200">
            ...
            {usage && (
              <div className="mb-2">
                <span className="font-bold text-sm uppercase tracking-wider text-gray-500">Usage Rule:</span>
                <p className="text-lg font-medium mt-1">{usage}</p>
              </div>
            )}
          </div>

          <div className="space-y-6">
            <h3 className="text-lg font-bold border-b border-gray-300 pb-2 mb-4">Exercises: Translate to Japanese</h3>
            {questions.map((q, i) => (
              <div key={q.id} className="mb-6 break-inside-avoid">
                <div className="flex items-baseline mb-2">
                  <span className="font-bold mr-3 text-gray-500">{i + 1}.</span>
                  <p className="text-lg">{q.english}</p>
                </div>
                <div className="h-24 border-b border-gray-300 border-dashed mt-2"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="print-break-before">
          <div className="flex justify-between items-end border-b-2 border-black pb-4 mb-6">
            ...
            <p className="text-sm text-gray-600">{grammarPoint}</p>
          </div>

          <div className="space-y-6">
            {questions.map((q, i) => (
              <div key={q.id} className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200 break-inside-avoid">
                <div className="flex items-baseline mb-2">
                  <span className="font-bold mr-3 text-gray-500">{i + 1}.</span>
                  <p className="font-medium">{q.english}</p>
                </div>
                <div className="ml-6 space-y-1">
                  <p className="text-xl font-bold mt-1">{q.japanese}</p>
                  <p className="text-sm text-gray-600">{q.kana}</p>
                  <p className="text-xs text-gray-500 italic mt-1">{q.romaji}</p>
